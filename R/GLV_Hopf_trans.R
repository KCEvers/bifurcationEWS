#' @title Hopf bifurcation in GLV model (transition model)
#' @description Data set of a Hopf bifurcation in the Generalized Lotka Volterra model which was generated using bifurcation_ts()
#' @format A named list:
#' \describe{
