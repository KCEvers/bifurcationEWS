#' @title Example GLV model
#' @description Data set of a range of transitions  for bifurcation parameter range s = .96 to s = .97 in steps of 0.0001 generated using bifurcation_ts()
#' @format A named list:
#' \describe{
