#' @title Saddle-node bifurcation in GLV model (transition model)
#' @description Data set of a saddle-node bifurcation in the Generalized Lotka Volterra model which was generated using bifurcation_ts()
#' @format A named list:
#' \describe{
...
#'   \item{fs}{Sampling frequency for downsampling if do_downsample = TRUE}
#'   \item{which_X}{Time point(s) in downsampling window to select if do_downsample = TRUE}
#'}
"GLV_SN_trans"
