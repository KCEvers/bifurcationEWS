...
By changing $s$ gradually, we may produce *bifurcations*: qualitative changes in the dynamics due to small changes in the control parameter.
...
sel_bifpar_idxs = seq(1, length(GLV$bifpar_list), length.out = 6)
