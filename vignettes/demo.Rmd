...
```{r intermittency}
nr_timesteps = 100
bifpar_list = purrr::transpose(expand.grid(s = seq(.965, .985, by = .01)))
...
desired_switch = regime_list$regime_bounds[regime_list$regime_bounds$regime1 == "Period-16 (X2,X3,X4) AND Period-20 (X1)" & regime_list$regime_bounds$regime2 == "Chaotic or Transitioning",]
