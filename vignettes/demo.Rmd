...
df = GLV$df
head(df)
# saveRDS(GLV, file.path(dirname(getwd(), "test2.RDS")))
# GLV = readRDS(file.path(dirname(getwd()), "test2.RDS"))
# df=GLV$df
...
pl_EWS <- split_df_EWS %>% ggplot() +
  ...
  ggh4x::facet_wrap2(. ~ metric, ncol = 3, scales = "free_y", labeller = label_func)
